(function () {
    ...
    WinJS.UI.Pages.define("/pages/home/home.html", {
        ...
        refreshPosition: function () {
            ...
            gl.getGeopositionAsync().done(function (position) {
                ...
                //on the map by showing the floating error on top of the iframe.
    ...
    function processFrameEvent(message) {
        ...
        switch (eventObj.event) {
            ...
            case "tryReloadMap":
                //Error image in map iframe was clicked, try to reload
                var mapFrame = document.frames["map"];

                //Clear the iframe src, then yield to UI thread and try resetting it (to reload the script)
                mapFrame.src = "";
                setImmediate(function () { mapFrame.src = "ms-appx-web:///html/map.html"; });
                break;
