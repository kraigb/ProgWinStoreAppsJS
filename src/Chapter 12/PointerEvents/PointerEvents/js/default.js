(function () {
    ...
    function initialize() {
        ...
        divElement.addEventListener("pointermove", pointerMove);
        divElement.addEventListener("pointerup", pointerUp);
        divElement.addEventListener("pointerover", pointerOver);
        divElement.addEventListener("pointerout", pointerOut);
        divElement.addEventListener("pointerenter", pointerEnter);
        divElement.addEventListener("pointerleave", pointerLeave);
    ...
    function pointerEnter(e) {
        logPointer("pointerEnter");
    }

    function pointerLeave(e) {
        logPointer("pointerLeave");
    }
