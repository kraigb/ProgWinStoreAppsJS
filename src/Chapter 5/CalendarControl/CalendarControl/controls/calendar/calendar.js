    ...
    WinJS.Namespace.define("Controls", {
        Calendar : WinJS.Class.define(
            ...
            function (element, options) {
                ...
                //Implement the disposal pattern with the help of WinJS.Utilities.markDisposable.
                //This adds the win-disposable class for us, maintains a flag to prevent reentrancy,
                //calls WinJS.Utilities.disposeSubTree, and hangs a dispose method from the class
