    ...
    function capturePhoto() {
        ...
        captureUI.captureFileAsync(Windows.Media.Capture.CameraCaptureUIMode.photo)
            ...
            .then(function (newFile) {
                ...
                //We can use ms-appdata here, but it's better to get a thumbnail from newFile instead. See scaleImageToFit
                //img.src = "ms-appdata:///local/HereMyAm/" + newFile.name; //newFile.name includes extension

                //Can use this form if copying images to the pictures library, but it's still better to use a thumbnail
