(function () {
    ...
    WinJS.UI.Pages.define("/pages/home/home.html", {
        ready: function ready(element, options) {
            ...
            //Using a webview, we listen to MSWebViewScriptNotify for events rather than window.onmessage
            var webview = document.getElementById("map");            
            webview.addEventListener("MSWebViewScriptNotify", processWebviewEvent);

            //Get a position for the map once the webview is loaded (modified from using iframe.onload)
            ...
            //Modified from setting iframe.src
        ...
        initFromState: function () {
            ...
            //Note that the call to updatePosition that was here previously is now
            //in the MSWebViewNavigationCompleted handler, because the webview won't
            //be initialized at this point when restoring state.            
        }
    });
    ...
    function updatePosition() {
        ...
        //Note that arguments is an object with named properties now
