...
(function () {
    ...
    var page = WinJS.UI.Pages.define("/html/scenario1.html", {
        ready: function (element, options) {
            ...
            //Addition to original SDK sample
            document.getElementById("simpleSwitchButton").addEventListener("click", simpleSwitch, false);
    ...
    function simpleSwitch() {
        ...
        viewSelect.selection.getItems().then(function (items) {
            if (items.length > 0) {
                view = items[0].data;
                ViewManagement.ApplicationViewSwitcher.switchAsync(view.viewId, ViewManagement.ApplicationView.getForCurrentView().id);
            }
        });
    }
